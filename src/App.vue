...
const faqs = [
  ...
  { q: '从哪里报名？奖金是多少？', a: '9 月 13 日起，通过本页动态二维码或腾讯问卷报名。参赛队伍须通过初赛、复赛，晋级后于 10 月 17 日参加 GOSIM 现场决赛。具体奖金金额待公布。' },
]
</script>
...
<template>
  ...
  <main id="main">
      ...
      <div class="hero-stage">
        <div class="hero-copy">
          ...
          <div class="hero-details">
            ...
            <p class="hero-theme">{{ t('2026.09.13–10.17 · 初赛 → 复赛 → 决赛') }}</p>
            
            <a class="location" href="https://shenzhen2026.gosim.org/" target="_blank" rel="noreferrer">{{ t('10.17 现场决赛 · GOSIM Shenzhen 2026 ↗') }}</a>
    ...
    <section id="participate" class="section participate"><p class="eyebrow">{{ t('09 / 参赛信息') }}</p><h2>{{ t('Agentic App 黑客松 2026') }}</h2><p><ConferenceText :text="t('2026 年 9 月 13 日开放报名组队，10 月 17 日在 GOSIM Shenzhen 2026 展示决赛项目。单人、多人均可参赛；队长和每位队员都须分别报名。初赛、复赛通过后晋级决赛。')" /></p><RegistrationPanel /><p class="small">{{ t('Agentic App 是独立赛事，与智能体工厂、智能体巡天黑客松并行。') }}</p></section>
  </main>
