...
const descriptions = {
  ...
  en: 'Agentic App Hackathon 2026: The Task Is the App. Turn a real intent into a working app with octos, OctoSense and Octoscript. Three steps, two award categories, and a live showcase at GOSIM Shenzhen 2026.',
}
watch(locale, value => {
  document.documentElement.lang = value === 'en' ? 'en' : 'zh-CN'
  document.title = value === 'en' ? 'Agentic App Hackathon 2026 · The Task Is the App' : 'Agentic App 黑客松 2026 · The Task Is the App'
