...
Registration links to the organizer-provided [Tencent Questionnaire form](https://wj.qq.com/s2/27846792/da0o/). `src/components/RegistrationPanel.vue` embeds the provided Qacman animated QR code and shows the full registration URL as a direct alternative. The site does not store form responses. The organizer confirmed registration opens September 13, 2026, kickoff takes place September 19, and the GOSIM winners’ showcase is October 17. Solo and team entries are welcome; captains and all members register individually. The local draft sets registration close on September 23, preliminary submission on September 28, semifinal submission on October 8, two review days per round, an online final on October 11 (14:00–17:00, results at 20:00), and October 12–16 for invited teams to confirm representatives, arrange travel and prepare their showcase. The final uses the app version frozen at the semifinal deadline, with presentation training open to all semifinalists on October 9 and connection checks on October 11. October 12 coaching, October 14 rehearsal, October 15 showcase-package freeze and October 16 equipment checks are for the invited winners; they do not affect online rankings. All times are UTC+8. The online final, other intermediate dates and exact training times are proposed; advancement quotas and resource redemption details are pending. See [the operational schedule](docs/competition-schedule.md) and [curriculum](docs/curriculum.md). Spotlight promotional copy describes a separate event and is not included.
...
MiniMax API credits and 50 Kimi coding benefit packages are provided separately for participant development, testing and improvements. Redemption and validity details will accompany distribution instructions. The post-event adoption window tracks contributions and archives projects without a separate promised cash award.
