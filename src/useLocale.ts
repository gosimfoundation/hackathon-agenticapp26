...
const descriptions = {
  zh: 'Agentic App 黑客松 2026：获奖奖池 ¥50,000（含现金奖金与 MiniMax Token 额度）。9 月 13 日报名、9 月 19 日开营，初赛、复赛和决赛均在线上完成。拟定 10 月 11 日决赛，前 2–3 名优胜团队获邀于 10 月 17 日在 GOSIM 现场展示。单人、多人均可参赛，每位成员分别报名。赛道：OctoSense + AppCard、robrix2 + hagency。',
  en: 'Agentic App Hackathon 2026: RMB 50,000 in prizes, including cash and MiniMax token credits. Register September 13; kickoff September 19. All rounds take place online, with the final proposed for October 11. The top 2–3 teams are invited to showcase at GOSIM on October 17. Solo and team entries welcome; every member registers. Tracks: OctoSense + AppCard and robrix2 + hagency.',
}
watch(locale, value => {
